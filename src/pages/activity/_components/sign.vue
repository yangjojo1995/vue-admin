  ...
  <div class="page">
    ...
    >
      ...
      <ym-row>
        ...
        <ym-col :span="8">
          <ym-form-item label="签到姓名" label-width="80px" style="width:100%">
            <ym-input
              :maxlength="100"
      ...
      <ym-row>
        <ym-col :span="16">
          <ym-form-item label="签到时间" label-width="80px" style="width:100%">
    ...
    >
      ...
      <ym-table-column prop="createTime" label="签到时间" min-width="120px">
        <span slot-scope="{ row }">{{
...
export default {
  ...
  data () {
    return {
      ...
      excelName: '签到记录',
      apiUrl: '/backstage/activity-sign-in/export',
      institutionOptions: []
    }
  },
  async created () {
  ...
  methods: {
    ...
    async requestService (paging, entity, orders) {
      ...
      return this.$service.activity.activitySign({
        ...paging,
        page: paging.page,
        ...entity,
        orders
